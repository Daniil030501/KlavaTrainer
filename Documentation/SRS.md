...
Графический интерфейс представлен в виде [мокапов](https://github.com/Daniil030501/KlavaTrainer/tree/main/Mockups). <br/>
При запуске приложения пользователь попадает в меню:

![Меню](https://github.com/Daniil030501/KlavaTrainer/blob/main/Mockups/Menu.png) <br/>

Далее при нажатие на кнопку "Настройки" появляется окно настроек:

![Настройки](https://github.com/Daniil030501/KlavaTrainer/blob/main/Mockups/Settings.png) <br/>

При нажатии на кнопку "Начать" в зависимости от выбранного вида тренировки пользователь перейдет к окнам игры:

![Игра1](https://github.com/Daniil030501/KlavaTrainer/blob/main/Mockups/StartTrainingForLearning.png) <br/>

![Игра2](https://github.com/Daniil030501/KlavaTrainer/blob/main/Mockups/StartTrainingForSpeed.png) <br/>
...
#### 3.2.2. Ограничения<a name="3.2.2"></a>
  ...
  1. Операционная система Windows11 и младше;
  2. Наличие Java 8.
